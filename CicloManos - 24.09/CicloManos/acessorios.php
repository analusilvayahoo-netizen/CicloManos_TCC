...
<body>
    ...
    <div class="container mb-5">
        ...
        $sql = "SELECT * FROM cicloprodutos 
                WHERE LOWER(produto) LIKE '%capacete%' 
                   OR LOWER(produto) LIKE '%luva%' 
                   OR LOWER(produto) LIKE '%garrafa%' 
                   OR LOWER(produto) LIKE '%suporte%' 
                   OR LOWER(produto) LIKE '%farol%' 
                   OR LOWER(produto) LIKE '%lanterna%' 
                   OR LOWER(produto) LIKE '%cadeado%' 
                   OR LOWER(produto) LIKE '%bomba%' 
                   OR LOWER(produto) LIKE '%bolsa%'
                     OR LOWER(produto) LIKE '%oculos%'
                   OR LOWER(categoria) LIKE '%acessorio%'
                   OR LOWER(categoria) LIKE '%acessório%'";
